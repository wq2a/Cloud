...
public class MainActivity extends Base implements TreeSelectionListener, MouseListener{
    ...
    private void setLayout(){   
        ...
        log = new JLabel("== Standard Mode ==");
        upload = new JButton("Upload");
        save = new JButton("Save");
        logout = new JButton("Logout");
        //getfile_btn = new JButton("getfile_btn");
        editfile_btn = new JButton("Edit File");
        newfile_btn = new JButton("New File");
        newdir_btn = new JButton("New Directory");
...
//        buttonpanel.add(log);
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource() == upload) {
            ...
            request(cnn);
        	log.setText("== Standard Mode ==");
        } else if (e.getSource() == newfile_btn){
...
//            cnn.setRequestProperty("Path",currentPath.substring(0,currentPath.lastIndexOf("/"))+"/"+n+"new_file.txt");
            cnn.setRequestProperty("Path",currentPath.substring(0,currentPath.lastIndexOf("/"))+"/"+result+".txt");
            request(cnn);

        } else if (e.getSource() == newdir_btn){
        	JFrame frame = new JFrame();
            ...
            request(cnn);
        } else if (e.getSource() == delfile_btn){
        	JFrame frame = new JFrame();
